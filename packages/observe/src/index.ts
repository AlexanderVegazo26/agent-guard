 ...
 * `@alexvegman/playwright`, which is the consumer of this package) now
 ...
 * Redaction (`Redactor`/`DefaultRedactor`) now lives in `@alexvegman/core`
 ...
 * that previously imported it from `@alexvegman/observe` breaks.
 */
export * from "./proxy.js";
export { DefaultRedactor, type Redactor, type RedactionAudit, type RedactionConfig } from "@alexvegman/core";
export * from "./mcp.js";
